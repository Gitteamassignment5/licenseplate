...
# Read the image
img = cv2.imread(r"D:\license\img1\101.jpg")
...
# Define constants for character grouping
...
# Function to find matched characters
def find_chars(contour_list):
    ...
    for d1 in contour_list:
        ...
        for d2 in contour_list:
            ...
            if distance < diagonal_length1 * MAX_DIAG_MULTIPLIER and angle_diff < MAX_ANGLE_DIFF and area_diff < MAX_AREA_DIFF and width_diff < MAX_WIDTH_DIFF and height_diff < MAX_HEIGHT_DIFF:
